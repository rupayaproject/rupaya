...
func (ch insertOrder) undo(s *RupXStateDB) {
	s.CancelOrder(ch.orderBook, ch.order)
}
func (ch cancelOrder) undo(s *RupXStateDB) {
	s.InsertOrderItem(ch.orderBook, ch.orderId, ch.order)
}
func (ch subAmountOrder) undo(s *RupXStateDB) {
...
func (ch nonceChange) undo(s *RupXStateDB) {
	s.SetNonce(ch.hash, ch.prev)
}
func (ch priceChange) undo(s *RupXStateDB) {
