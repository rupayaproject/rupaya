...
func newStateExchanges(db *RupXStateDB, hash common.Hash, data exchangeObject, onDirty func(addr common.Hash)) *stateExchanges {
...
func (self *stateExchanges) deepCopy(db *RupXStateDB, onDirty func(hash common.Hash)) *stateExchanges {
