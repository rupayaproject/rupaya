...
func New(root common.Hash, db Database) (*RupXStateDB, error) {
...
func (self *RupXStateDB) GetPrice(addr common.Hash) *big.Int {
	stateObject := self.getStateExchangeObject(addr)
	if stateObject != nil {
...
func (self *RupXStateDB) Database() Database {
	return self.db
}

func (self *RupXStateDB) SetNonce(addr common.Hash, nonce uint64) {
...
func (self *RupXStateDB) SetPrice(addr common.Hash, price *big.Int) {
	stateObject := self.GetOrNewStateExchangeObject(addr)
	if stateObject != nil {
...
func (self *RupXStateDB) InsertOrderItem(orderBook common.Hash, orderId common.Hash, order OrderItem) {
...
func (self *RupXStateDB) GetOrder(orderBook common.Hash, orderId common.Hash) OrderItem {
...
func (self *RupXStateDB) SubAmountOrderItem(orderBook common.Hash, orderId common.Hash, price *big.Int, amount *big.Int, side string) error {
...
func (self *RupXStateDB) CancelOrder(orderBook common.Hash, order *OrderItem) error {
...
func (self *RupXStateDB) GetVolume(orderBook common.Hash, price *big.Int, orderType string) *big.Int {
	stateObject := self.GetOrNewStateExchangeObject(orderBook)
...
func (self *RupXStateDB) GetBestAskPrice(orderBook common.Hash) (*big.Int, *big.Int) {
...
func (self *RupXStateDB) GetBestBidPrice(orderBook common.Hash) (*big.Int, *big.Int) {
	stateObject := self.getStateExchangeObject(orderBook)
	if stateObject != nil {
...
func (self *RupXStateDB) GetBestOrderIdAndAmount(orderBook common.Hash, price *big.Int, side string) (common.Hash, *big.Int, error) {
	stateObject := self.GetOrNewStateExchangeObject(orderBook)
	if stateObject != nil {
		var stateOrderList *stateOrderList
		switch side {
...
func (self *RupXStateDB) updateStateExchangeObject(stateObject *stateExchanges) {
...
func (self *RupXStateDB) getStateExchangeObject(addr common.Hash) (stateObject *stateExchanges) {
	// Prefer 'live' objects.
...
func (self *RupXStateDB) setStateExchangeObject(object *stateExchanges) {
	self.stateExhangeObjects[object.Hash()] = object
	self.stateExhangeObjectsDirty[object.Hash()] = struct{}{}
}

// Retrieve a state object or create a new state object if nil.
func (self *RupXStateDB) GetOrNewStateExchangeObject(addr common.Hash) *stateExchanges {
...
func (self *RupXStateDB) MarkStateExchangeObjectDirty(addr common.Hash) {
...
func (self *RupXStateDB) createExchangeObject(hash common.Hash) (newobj *stateExchanges) {
...
func (self *RupXStateDB) Copy() *RupXStateDB {
	self.lock.Lock()
...
func (s *RupXStateDB) clearJournalAndRefund() {
	s.journal = nil
	s.validRevisions = s.validRevisions[:0]
}

// Snapshot returns an identifier for the current revision of the state.
func (self *RupXStateDB) Snapshot() int {
...
func (self *RupXStateDB) RevertToSnapshot(revid int) {
...
func (s *RupXStateDB) IntermediateRoot() common.Hash {
	s.Finalise()
	return s.trie.Hash()
}

// Commit writes the state to the underlying in-memory trie database.
func (s *RupXStateDB) Commit() (root common.Hash, err error) {
	...
	log.Debug("RupX Trie cache stats after commit", "misses", trie.CacheMisses(), "unloads", trie.CacheUnloads(), "root", root.Hex())
	return root, err
}
