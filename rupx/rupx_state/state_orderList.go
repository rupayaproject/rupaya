...
func newStateOrderList(db *RupXStateDB, orderType string, orderBook common.Hash, price common.Hash, data orderList, onDirty func(price common.Hash)) *stateOrderList {
...
func (self *stateOrderList) deepCopy(db *RupXStateDB, onDirty func(price common.Hash)) *stateOrderList {
