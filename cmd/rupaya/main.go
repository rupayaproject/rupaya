...
const (
	clientIdentifier = "rupx" // Client identifier to advertise over the network
)
...
var (
	...
	nodeFlags = []cli.Flag{
		...
		utils.RupXEnabledFlag,
		utils.RupXDataDirFlag,
		utils.RupXDBEngineFlag,
		utils.RupXDBConnectionUrlFlag,
		utils.RupXDBReplicaSetNameFlag,
		utils.RupXDBNameFlag,
...
func init() {
	...
	app.Copyright = "Copyright (c) 2020 Rupaya"
