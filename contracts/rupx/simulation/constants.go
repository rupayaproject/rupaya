...
var (
	BaseRUPX    = big.NewInt(0).Mul(big.NewInt(10), big.NewInt(100000000000000000)) // 1 RUPX
	...
	// RRC21 Token
	MinRRC21Apply  = big.NewInt(0).Mul(big.NewInt(10), BaseRUPX) // 10 RUPX
	RRC21TokenCap  = big.NewInt(0).Mul(big.NewInt(1000000000000), BaseRUPX)
	RRC21TokenFee  = big.NewInt(100)
	RupXListingFee = big.NewInt(0).Mul(big.NewInt(1000), BaseRUPX) // 1000 RUPX

	// RUPX
	MaxRelayers               = big.NewInt(200)
	MaxTokenList              = big.NewInt(200)
	MinDeposit                = big.NewInt(0).Mul(big.NewInt(25000), BaseRUPX) // 25000 RUPX
	...
	RUPXNative = common.HexToAddress("0x0000000000000000000000000000000000000001")
	...
	TeamAddresses = []common.Address{
		...
		//common.HexToAddress("0x16a73f3a64eca79e117258e66dfd7071cc8312a9"), // BTCRUPX
		//common.HexToAddress("0xac177441ac2237b2f79ecff1b8f6bca39e27ef9f"), // ETHRUPX
		//common.HexToAddress("0x4215250e55984c75bbce8ae639b86a6cad8ec126"), // XRPRUPX
		//common.HexToAddress("0x6b70ca959814866dd5c426d63d47dde9cc6c32d2"), // LTCRUPX
		//common.HexToAddress("0x33df079fe9b9cd7fb23a1085e4eaaa8eb6952cb3"), // BNBRUPX
		//common.HexToAddress("0x3cab8292137804688714670640d19f9d7a60c472"), // ADARUPX
		//common.HexToAddress("0x9415d953d47c5f155cac9de7b24a756f352eafbf"), // ETCRUPX
		//common.HexToAddress("0xe32d2e7c8e8809e45c8e2332830b48d9e231e3f2"), // BCHRUPX
		//common.HexToAddress("0xf76ddbda664ea47088937e1cf9ff15036714dee3"), // EOSRUPX
		...
		//common.HexToAddress("0xe36c1842365595D44854eEcd64B11c8115E133EF"), // USDRUPX
	...
	Owners   = []common.Address{
		...
		// Initial 3 MN, Seems like the same principle is applied here
	}
)
