...
/**
 * @title Standard RRC21 token
 * @dev Implementation of the basic standard token.
 */
contract RRC21 is IRRC21 {
...
contract MyRRC21 is RRC21 {
    ...
    constructor (address[] _owners,
                ...
                ) RRC21(_name, _symbol, _decimals) public validRequirement(_owners.length, _required) {
