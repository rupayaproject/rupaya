...
// LAbstractRUPXListingABI is the input ABI used to generate the binding from.
const LAbstractRUPXListingABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"getTokenStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractRUPXListingBin is the compiled bytecode used for deploying new contracts.
const LAbstractRUPXListingBin = `0x`

// DeployLAbstractRUPXListing deploys a new Ethereum contract, binding an instance of LAbstractRUPXListing to it.
func DeployLAbstractRUPXListing(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractRUPXListing, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractRUPXListingABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractRUPXListingBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractRUPXListing{LAbstractRUPXListingCaller: LAbstractRUPXListingCaller{contract: contract}, LAbstractRUPXListingTransactor: LAbstractRUPXListingTransactor{contract: contract}, LAbstractRUPXListingFilterer: LAbstractRUPXListingFilterer{contract: contract}}, nil
}

// LAbstractRUPXListing is an auto generated Go binding around an Ethereum contract.
type LAbstractRUPXListing struct {
	LAbstractRUPXListingCaller     // Read-only binding to the contract
	LAbstractRUPXListingTransactor // Write-only binding to the contract
	LAbstractRUPXListingFilterer   // Log filterer for contract events
}

// LAbstractRUPXListingCaller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractRUPXListingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractRUPXListingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractRUPXListingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractRUPXListingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractRUPXListingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractRUPXListingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractRUPXListingSession struct {
	Contract     *LAbstractRUPXListing // Generic contract binding to set the session for
	CallOpts     bind.CallOpts         // Call options to use throughout this session
	TransactOpts bind.TransactOpts     // Transaction auth options to use throughout this session
}

// LAbstractRUPXListingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractRUPXListingCallerSession struct {
	Contract *LAbstractRUPXListingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts               // Call options to use throughout this session
}

// LAbstractRUPXListingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractRUPXListingTransactorSession struct {
	Contract     *LAbstractRUPXListingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts               // Transaction auth options to use throughout this session
}

// LAbstractRUPXListingRaw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractRUPXListingRaw struct {
	Contract *LAbstractRUPXListing // Generic contract binding to access the raw methods on
}

// LAbstractRUPXListingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractRUPXListingCallerRaw struct {
	Contract *LAbstractRUPXListingCaller // Generic read-only contract binding to access the raw methods on
}

// LAbstractRUPXListingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractRUPXListingTransactorRaw struct {
	Contract *LAbstractRUPXListingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractRUPXListing creates a new instance of LAbstractRUPXListing, bound to a specific deployed contract.
func NewLAbstractRUPXListing(address common.Address, backend bind.ContractBackend) (*LAbstractRUPXListing, error) {
	contract, err := bindLAbstractRUPXListing(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractRUPXListing{LAbstractRUPXListingCaller: LAbstractRUPXListingCaller{contract: contract}, LAbstractRUPXListingTransactor: LAbstractRUPXListingTransactor{contract: contract}, LAbstractRUPXListingFilterer: LAbstractRUPXListingFilterer{contract: contract}}, nil
}

// NewLAbstractRUPXListingCaller creates a new read-only instance of LAbstractRUPXListing, bound to a specific deployed contract.
func NewLAbstractRUPXListingCaller(address common.Address, caller bind.ContractCaller) (*LAbstractRUPXListingCaller, error) {
	contract, err := bindLAbstractRUPXListing(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractRUPXListingCaller{contract: contract}, nil
}

// NewLAbstractRUPXListingTransactor creates a new write-only instance of LAbstractRUPXListing, bound to a specific deployed contract.
func NewLAbstractRUPXListingTransactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractRUPXListingTransactor, error) {
	contract, err := bindLAbstractRUPXListing(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractRUPXListingTransactor{contract: contract}, nil
}

// NewLAbstractRUPXListingFilterer creates a new log filterer instance of LAbstractRUPXListing, bound to a specific deployed contract.
func NewLAbstractRUPXListingFilterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractRUPXListingFilterer, error) {
	contract, err := bindLAbstractRUPXListing(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractRUPXListingFilterer{contract: contract}, nil
}

// bindLAbstractRUPXListing binds a generic wrapper to an already deployed contract.
func bindLAbstractRUPXListing(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractRUPXListingABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractRUPXListing *LAbstractRUPXListingRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractRUPXListing.Contract.LAbstractRUPXListingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractRUPXListing *LAbstractRUPXListingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractRUPXListing.Contract.LAbstractRUPXListingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractRUPXListing *LAbstractRUPXListingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractRUPXListing.Contract.LAbstractRUPXListingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractRUPXListing *LAbstractRUPXListingCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractRUPXListing.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractRUPXListing *LAbstractRUPXListingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractRUPXListing.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractRUPXListing *LAbstractRUPXListingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractRUPXListing.Contract.contract.Transact(opts, method, params...)
}
...
func (_LAbstractRUPXListing *LAbstractRUPXListingCaller) GetTokenStatus(opts *bind.CallOpts, arg0 common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _LAbstractRUPXListing.contract.Call(opts, out, "getTokenStatus", arg0)
	return *ret0, err
}
...
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractRUPXListing *LAbstractRUPXListingSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractRUPXListing.Contract.GetTokenStatus(&_LAbstractRUPXListing.CallOpts, arg0)
}

// GetTokenStatus is a free data retrieval call binding the contract method 0xa3ff31b5.
//
// Solidity: function getTokenStatus( address) constant returns(bool)
func (_LAbstractRUPXListing *LAbstractRUPXListingCallerSession) GetTokenStatus(arg0 common.Address) (bool, error) {
	return _LAbstractRUPXListing.Contract.GetTokenStatus(&_LAbstractRUPXListing.CallOpts, arg0)
}

// LAbstractTokenRRC21ABI is the input ABI used to generate the binding from.
const LAbstractTokenRRC21ABI = "[{\"constant\":true,\"inputs\":[],\"name\":\"issuer\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"}]"

// LAbstractTokenRRC21Bin is the compiled bytecode used for deploying new contracts.
const LAbstractTokenRRC21Bin = `0x`

// DeployLAbstractTokenRRC21 deploys a new Ethereum contract, binding an instance of LAbstractTokenRRC21 to it.
func DeployLAbstractTokenRRC21(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *LAbstractTokenRRC21, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTokenRRC21ABI))
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, common.FromHex(LAbstractTokenRRC21Bin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &LAbstractTokenRRC21{LAbstractTokenRRC21Caller: LAbstractTokenRRC21Caller{contract: contract}, LAbstractTokenRRC21Transactor: LAbstractTokenRRC21Transactor{contract: contract}, LAbstractTokenRRC21Filterer: LAbstractTokenRRC21Filterer{contract: contract}}, nil
}

// LAbstractTokenRRC21 is an auto generated Go binding around an Ethereum contract.
type LAbstractTokenRRC21 struct {
	LAbstractTokenRRC21Caller     // Read-only binding to the contract
	LAbstractTokenRRC21Transactor // Write-only binding to the contract
	LAbstractTokenRRC21Filterer   // Log filterer for contract events
}

// LAbstractTokenRRC21Caller is an auto generated read-only Go binding around an Ethereum contract.
type LAbstractTokenRRC21Caller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTokenRRC21Transactor is an auto generated write-only Go binding around an Ethereum contract.
type LAbstractTokenRRC21Transactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTokenRRC21Filterer is an auto generated log filtering Go binding around an Ethereum contract events.
type LAbstractTokenRRC21Filterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// LAbstractTokenRRC21Session is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type LAbstractTokenRRC21Session struct {
	Contract     *LAbstractTokenRRC21 // Generic contract binding to set the session for
	CallOpts     bind.CallOpts        // Call options to use throughout this session
	TransactOpts bind.TransactOpts    // Transaction auth options to use throughout this session
}

// LAbstractTokenRRC21CallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type LAbstractTokenRRC21CallerSession struct {
	Contract *LAbstractTokenRRC21Caller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts              // Call options to use throughout this session
}

// LAbstractTokenRRC21TransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type LAbstractTokenRRC21TransactorSession struct {
	Contract     *LAbstractTokenRRC21Transactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts              // Transaction auth options to use throughout this session
}

// LAbstractTokenRRC21Raw is an auto generated low-level Go binding around an Ethereum contract.
type LAbstractTokenRRC21Raw struct {
	Contract *LAbstractTokenRRC21 // Generic contract binding to access the raw methods on
}

// LAbstractTokenRRC21CallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type LAbstractTokenRRC21CallerRaw struct {
	Contract *LAbstractTokenRRC21Caller // Generic read-only contract binding to access the raw methods on
}

// LAbstractTokenRRC21TransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type LAbstractTokenRRC21TransactorRaw struct {
	Contract *LAbstractTokenRRC21Transactor // Generic write-only contract binding to access the raw methods on
}

// NewLAbstractTokenRRC21 creates a new instance of LAbstractTokenRRC21, bound to a specific deployed contract.
func NewLAbstractTokenRRC21(address common.Address, backend bind.ContractBackend) (*LAbstractTokenRRC21, error) {
	contract, err := bindLAbstractTokenRRC21(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenRRC21{LAbstractTokenRRC21Caller: LAbstractTokenRRC21Caller{contract: contract}, LAbstractTokenRRC21Transactor: LAbstractTokenRRC21Transactor{contract: contract}, LAbstractTokenRRC21Filterer: LAbstractTokenRRC21Filterer{contract: contract}}, nil
}

// NewLAbstractTokenRRC21Caller creates a new read-only instance of LAbstractTokenRRC21, bound to a specific deployed contract.
func NewLAbstractTokenRRC21Caller(address common.Address, caller bind.ContractCaller) (*LAbstractTokenRRC21Caller, error) {
	contract, err := bindLAbstractTokenRRC21(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenRRC21Caller{contract: contract}, nil
}

// NewLAbstractTokenRRC21Transactor creates a new write-only instance of LAbstractTokenRRC21, bound to a specific deployed contract.
func NewLAbstractTokenRRC21Transactor(address common.Address, transactor bind.ContractTransactor) (*LAbstractTokenRRC21Transactor, error) {
	contract, err := bindLAbstractTokenRRC21(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenRRC21Transactor{contract: contract}, nil
}

// NewLAbstractTokenRRC21Filterer creates a new log filterer instance of LAbstractTokenRRC21, bound to a specific deployed contract.
func NewLAbstractTokenRRC21Filterer(address common.Address, filterer bind.ContractFilterer) (*LAbstractTokenRRC21Filterer, error) {
	contract, err := bindLAbstractTokenRRC21(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &LAbstractTokenRRC21Filterer{contract: contract}, nil
}

// bindLAbstractTokenRRC21 binds a generic wrapper to an already deployed contract.
func bindLAbstractTokenRRC21(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(LAbstractTokenRRC21ABI))
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractTokenRRC21 *LAbstractTokenRRC21Raw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTokenRRC21.Contract.LAbstractTokenRRC21Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTokenRRC21 *LAbstractTokenRRC21Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTokenRRC21.Contract.LAbstractTokenRRC21Transactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractTokenRRC21 *LAbstractTokenRRC21Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTokenRRC21.Contract.LAbstractTokenRRC21Transactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_LAbstractTokenRRC21 *LAbstractTokenRRC21CallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _LAbstractTokenRRC21.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_LAbstractTokenRRC21 *LAbstractTokenRRC21TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _LAbstractTokenRRC21.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_LAbstractTokenRRC21 *LAbstractTokenRRC21TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _LAbstractTokenRRC21.Contract.contract.Transact(opts, method, params...)
}

// Issuer is a free data retrieval call binding the contract method 0x1d143848.
//
// Solidity: function issuer() constant returns(address)
func (_LAbstractTokenRRC21 *LAbstractTokenRRC21Caller) Issuer(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _LAbstractTokenRRC21.contract.Call(opts, out, "issuer")
	return *ret0, err
}
...
// RupXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function RupXListing() constant returns(address)
func (_Lending *LendingCaller) RupXListing(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Lending.contract.Call(opts, out, "RupXListing")
	return *ret0, err
}
...
//
// Solidity: function RupXListing() constant returns(address)
func (_Lending *LendingSession) RupXListing() (common.Address, error) {
	return _Lending.Contract.RupXListing(&_Lending.CallOpts)
}

// RupXListing is a free data retrieval call binding the contract method 0x29a4ddec.
//
// Solidity: function RupXListing() constant returns(address)
func (_Lending *LendingCallerSession) RupXListing() (common.Address, error) {
	return _Lending.Contract.RupXListing(&_Lending.CallOpts)
}
