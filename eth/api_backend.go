...
import (
	...
	"github.com/rupayaproject/rupaya/contracts"
	"github.com/rupayaproject/rupaya/core"
	"github.com/rupayaproject/rupaya/core/bloombits"
	"github.com/rupayaproject/rupaya/core/state"
	stateDatabase "github.com/rupayaproject/rupaya/core/state"
	...
	"github.com/rupayaproject/rupaya/eth/gasprice"
...
func (b *EthApiBackend) GetOrderNonce(address common.Hash) (uint64, error) {
	...
	if rupxService != nil {
		rupxState, err := rupxService.GetTradingState(b.CurrentBlock())
		if err != nil {
			return 0, err
		}
...
func (b *EthApiBackend) LendingService() *rupxlending.Lending {
